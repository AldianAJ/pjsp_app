    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Jenis Mesin</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('jenis-mesin.create') }}" class="btn btn-primary my-2"><i
                            ...
                            <tbody>
                                @foreach ($JenisMesins as $jenis)
                                    <tr>
                                        ...
                                        <td>{{ $jenis->nama }}</td>
                                        <td>
                                            <a href="{{ route('jenis-mesin.edit', ['jenis_id' => $jenis->jenis_id]) }}"
