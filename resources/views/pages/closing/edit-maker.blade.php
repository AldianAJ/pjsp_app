                ...
                foreach ($fields as $index => $field) {
                    echo '<div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <div class="col-xl-9">
                                        <input type="text" class="form-control number" value="'. $formReject[$field['name']] .'" name="' . $field['name'] .'" id="rejectInput-' . $index . '" placeholder="' . $field['placeholder'] . '" pattern="\d*" inputmode="numeric" required>
                                    </div>
                                    <label class="col-md-2 col-form-label ms-2">' . $field['satuan'] . '</label>
                                </div>
                            </div>
                ...
                foreach ($fields as $index => $field) {
                    echo '<div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <div class="col-xl-9">
                                        <input type="text" class="form-control number" value="'. $formBahan[$field['name']] .'" name="' . $field['name'] .'" id="bahanInput-' . $index . '" placeholder="' . $field['placeholder'] . '" pattern="\d*" inputmode="numeric" required>
                                    </div>
                                    <label class="col-md-2 col-form-label ms-2">' . $field['satuan'] . '</label>
                                </div>
                            </div>
