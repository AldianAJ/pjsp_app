    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editDataBarangModal').on('click', '.save-btn', function() {
                ...
                console.log('Input qty_beli:', qtyInput[0]);
                console.log('Input qty_std:', qtyInputKonversi[0]);

                console.log('Input qty_beli:', qty_beli);
                console.log('Input qty_std:', qty_std);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $row.find('.qty-value').text(AutoNumeric.format(qty_beli)).removeClass(
                            'd-none');
                        $row.find('.qty-value-konversi').text(AutoNumeric.format(qty_std))
                            .removeClass('d-none');
