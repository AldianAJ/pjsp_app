            ...
            $('input[name="tgl"]').on('change', function() {
                ...
                $('#datatable-shifts').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: null,
                            render: (data, type, row) => `<button type="button" class="btn btn-primary font-size-10 waves-effect waves-light" onclick="showSpecs('${row.shift_id}')">
                        <i class="fas fa-plus align-middle"></i>
                    </button>`
                        }
                    ]
...
@section('content')
    ...
    <div class="modal fade" id="dataShift" tabindex="-1" role="dialog" aria-labelledby="shiftModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="dataSpek" tabindex="-1" role="dialog" aria-labelledby="dataSpekLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center">
                            <input type="text" inputmode="numeric" class="form-control me-2" id="modal-qty-beli"
                                min="1" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center">
                            <input type="text" inputmode="numeric" class="form-control me-2" id="modal-qty-std"
                                min="1" required>
