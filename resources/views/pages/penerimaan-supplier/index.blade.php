...
<script>
    let mainTable;
        ...
        $(document).ready(function() {
            ...
            $('#filterSupplier, #filterMonthYear').on('change', function() {
                mainTable.draw();
            });
        ...
        $('#datatable').on('click', '.btn-detail', function() {
            ...
            $('#detail-datatable').DataTable({
                ...
                ajax: {
                    type: "GET",
                    url: "{{ route('penerimaan-supplier.detail') }}",
                    data: {
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-end mb-2">
                    <a href="{{ route('penerimaan-supplier.create') }}" class="btn btn-primary my-2">
