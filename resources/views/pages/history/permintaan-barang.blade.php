...
@push('after-script')
    ...
    <script>
        let permintaan BarangDatatable = $('#permintaan-datatable').DataTable({
            ajax: {
                url: "{{ route('permintaan-barang.history') }}",
            },
            columns: [{
                    data: "brg_id",
                    name: "brg_id"
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">History Permintaan Barang</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <table id="permintaan-datatable" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="#" class="btn btn-secondary waves-effect waves-light mx-1"><i
                                            class="bx bx-edit align-middle me-2 font-size-18"></i>
                                        Detail</a><a href="#" class="btn btn-primary waves-effect waves-light mx-1"><i
                                            class="bx bx-edit align-middle me-2 font-size-18"></i>
                                        Cetak PDF</a></td>
                            </tr>
                        </tbody>
